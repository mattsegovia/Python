...
def connect():
    ...
    curr = conn.cursor()
    curr.execute("CREATE TABLE IF NOT EXISTS book(id INTEGER PRIMARY KEY, "
...
def view():
    # No changes to the db so conn.commit() is not needed
    conn = sqlite3.connect("books.db")
    curr = conn.cursor()
...
connect()
# insert("The Sun", "Jack Smith", 1918, 123456789)
# delete(4)
# update(3, "The Moon", "John Smooth", 1917, 789456)
# print(view())
